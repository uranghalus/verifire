...
import { AparMultiDeleteDialog } from './apar-multi-delete-dialog'
...
export function DataTableBulkActions<TData>({
    ...
    const handleBulkExport = () => {
        ...
        toast.promise(sleep(2000), {
            ...
            success: () => {
                ...
                return `Berhasil mengekspor ${selectedApar.length} data APAR`
            },
    ...
    const handleBulkArchive = () => {
        ...
        toast.promise(sleep(2000), {
            ...
            success: () => {
                table.resetRowSelection()
                return `Berhasil mengarsipkan ${selectedApar.length} data APAR`
            },
    ...
    return (
        <>
            <DataTableBulkActionToolbar table={table} entityName='APAR'>
                <Tooltip>
